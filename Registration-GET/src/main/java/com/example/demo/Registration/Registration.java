...
public class Registration {
    ...
    private com.example.demo.Account.Account Account;
    ...
    public com.example.demo.Account.Account getAccount() {
        return Account;
    }

    public void setAccount(com.example.demo.Account.Account account) {
        Account = account;
    }
}
